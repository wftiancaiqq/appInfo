...
<title>APP开发者平台</title>
	...
	<link href="${pageContext.request.contextPath }/myProjectAssets/css/dropzone.min.css" rel="stylesheet">
	<!-- Custom Theme Style -->
	<link href="${pageContext.request.contextPath }/myProjectAssets/css/custom.min.css"	rel="stylesheet">
	
	<!-- add localcss 2016-8-18 -->
	<link href='${pageContext.request.contextPath }/myProjectAssets/localcss/appinfoadd.css' rel='stylesheet'>
	<link href='${pageContext.request.contextPath }/myProjectAssets/localcss/appinfolist.css' rel='stylesheet'>
</head>
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/devUserController/goDevUserMain" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
					...
					<div class="profile">
						<div class="profile_pic">
							<img
								src="${pageContext.request.contextPath }/myProjectAssets/images/img.jpg"
								alt="..." class="img-circle profile_img">
						</div>
						<div class="profile_info">
							<span>Welcome,</span>
							<h2>${sessionScope.devUserSession.devCode }</h2>
						</div>
					</div>
					<!-- /menu profile quick info -->
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>${sessionScope.devUserSession.devName }</h3>
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="/appInfoDevController/appInfoList">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${pageContext.request.contextPath }/devUserController/logOut"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="/devUserController/logOut"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
									</li>
								</ul></li>
