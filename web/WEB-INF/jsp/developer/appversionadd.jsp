    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
			...
			<div class="row">
				<div class="col-sm-12">
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
						...
						<tbody>
							<c:choose>
                                <c:when test="${sessionScope.appVersion != null}">
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="/appInfoDevController/appversionaddInfo" method="post" enctype="multipart/form-data">
           <input type="hidden" name="appId" value="${sessionScope.appInfoId}">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="file" class="form-control col-md-7 col-xs-12" name="appDownloadLink " id="a_downloadLink" required/>
